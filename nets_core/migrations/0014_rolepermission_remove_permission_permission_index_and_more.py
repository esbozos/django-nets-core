...
def pre_migration(apps, schema_editor):
    ...
    for p in Permission.objects.all():
        if p.codename not in unique_codenames:
            ...
            other_permissions = Permission.objects.filter(codename=p.codename).exclude(id=p.id)
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_fields', models.JSONField(blank=True, default=dict, null=True, verbose_name='Updated fields')),
                ('custom_name', models.CharField(blank=True, max_length=150, null=True, verbose_name='Custom name')),                
            ],
            options={
        ...
        migrations.AddField(
            model_name='rolepermission',
            name='permission',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nets_core.permission'),
        ),
        ...
        migrations.AddField(
            model_name='role',
            name='permissions',
            field=models.ManyToManyField(related_name='roles', through='nets_core.RolePermission', to='nets_core.permission'),
        ),
